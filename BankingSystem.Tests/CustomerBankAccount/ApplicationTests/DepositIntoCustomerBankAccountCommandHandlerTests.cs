...
{
    public class DepositIntoCustomerBankAccountCommandHandlerTests
    {
        private readonly Mock<ICustomerBankAccountRepository> _mockCustomerBankAccountRepository;
        private readonly DepositIntoCustomerBankAccountCommandHandler _sut;
        private readonly Fixture _fixture = new();

        public DepositIntoCustomerBankAccountCommandHandlerTests()
        {
            _mockCustomerBankAccountRepository = new Mock<ICustomerBankAccountRepository>();
            _sut = new DepositIntoCustomerBankAccountCommandHandler(_mockCustomerBankAccountRepository.Object);
        }
        ...
        {
            //arrange
            var command = new DepositIntoCustomerBankAccountCommand(1, 1, 100);
